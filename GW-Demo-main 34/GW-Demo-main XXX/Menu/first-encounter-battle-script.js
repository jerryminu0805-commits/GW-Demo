...
const units = {};
// 玩家 - 初见赫雷西战斗 (等级 25)
units['karma'] = createUnit('karma','Karma','player',25, 9, 11, 200,50, 0.5,20, ['violentAddiction','toughBody','pride']);
units['adora'] = createUnit('adora','Adora','player',25, 8, 11, 100,100, 0.5,0, ['backstab','calmAnalysis','proximityHeal','fearBuff']);
units['dario'] = createUnit('dario','Dario','player',25, 7, 11, 150,100, 0.75,0, ['quickAdjust','counter','moraleBoost']);
...
units['cultist1'] = createUnit('cultist1','雏形赫雷西成员','enemy',25, 2, 8, 150, 70, 0.8, 0, ['loyalFaith','gift','strengthenedBody','acceptGuidance'], cultistConfig);
units['cultist2'] = createUnit('cultist2','雏形赫雷西成员','enemy',25, 3, 7, 150, 70, 0.8, 0, ['loyalFaith','gift','strengthenedBody','acceptGuidance'], cultistConfig);
units['cultist3'] = createUnit('cultist3','雏形赫雷西成员','enemy',25, 3, 9, 150, 70, 0.8, 0, ['loyalFaith','gift','strengthenedBody','acceptGuidance'], cultistConfig);
...
units['mage1'] = createUnit('mage1','法形赫雷西成员','enemy',25, 2, 3, 100, 90, 0.8, 0, ['loyalFaith','gift','strengthenedBody','acceptGuidance'], mageConfig);
units['mage2'] = createUnit('mage2','法形赫雷西成员','enemy',25, 2, 13, 100, 90, 0.8, 0, ['loyalFaith','gift','strengthenedBody','acceptGuidance'], mageConfig);
